...
import com.candyz.a7center.cards.model.Data;
...
public class GameScene extends BaseScene implements IOnSceneTouchListener
{
	...
	public void createScene()
	{
        ...
        /*Data.getInstance().getDeck().shuffle();
        for(int i = 0; i < Data.getInstance().getDeck().get().size(); i++)
        {
            CardView cv = new CardView(Data.getInstance().getDeck().get(i), activity, resourcesManager.activity.getTextureManager(), vbom, this);
            cv.setPosition(i * 15, 200);
            cv.open();
        }*/
        ...
        SevenCenter sevenCenter = new SevenCenter(new PlayerFactory(), new DeckFactory());
	...
	{
        setBackground(new Background(new Color(0.0f, 0.25f, 0.0f, 1.0f)));
	}
